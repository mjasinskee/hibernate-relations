...
class EmployeeRepositoryIT {
    ...
    public void should() {
        ...
        repository.save(new Employee("name3", Department.IT, BigDecimal.valueOf(12000)));
        repository.save(new Employee("name4", Department.IT, BigDecimal.valueOf(12000)));
        repository.save(new Employee("name4", Department.HR, BigDecimal.valueOf(12000)));
